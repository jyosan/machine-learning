...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
       ...
       # self.epsilon = self.epsilon  - 0.05
        ...
        self.epsilon = 1/(self.ntrials *self.ntrials)
...
def run():
    ...
    agent = env.create_agent(LearningAgent,learning = True, epsilon = .7, alpha = .5)
    ...
    sim = Simulator(env,display=True, update_delay = .01, log_metrics = True, optimized = True)
    ...
    sim.run(n_test = 10, tolerance = .07)
